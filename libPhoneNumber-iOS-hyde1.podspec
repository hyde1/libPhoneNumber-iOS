Pod::Spec.new do |s|
  s.name         = "libPhoneNumber-iOS-hyde1"
  s.version      = "1.0.4"
...
DESC
  s.homepage     = "https://github.com/hyde1/libPhoneNumber-iOS.git"
  s.license      = 'Apache License, Version 2.0 (http://www.apache.org/licenses/LICENSE-2.0)'
  s.authors      = { "iziz" => "zen.isis@gmail.com", "hyukhur" => "hyukhur@gmail.com" }
  s.source       = { :git => "https://github.com/hyde1/libPhoneNumber-iOS.git", :tag => s.version.to_s }
  s.libraries 	 = 'z'
